...
public class pStorage extends FileInputLoadFunc implements StoreFuncInterface,
LoadPushDown, LoadMetadata, StoreMetadata {
     ...
     */
    public pStorage(String delimiter) {
        this(delimiter, "");
    }
     ...
     * @throws ParseException
     */
    public pStorage(String delimiter, String options) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof pStorage)
            return equals((pStorage)obj);
        else
            return false;
    }

    public boolean equals(pStorage other) {
